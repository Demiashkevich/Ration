...
<main>
  ...
  <section class="sc"><!--Section Create-->
    ...
    <h1 class="sc-title"><span class="sc-title-text fade-in latest">Edit Product</span></h1>
  </section>
  <section  class="si"><!--Sign In-->
    <s:form action="${pageContext.request.contextPath}/product/update" method="POST" commandName="productDto">
      <ul class="si-list">
        <li class="si-item">
          <s:input class="form-input size-input-sign-up" type="text" path="name" placeholder="name" autofocus="false" tabindex="1" value="${productDto.name}"/>
          <s:errors path="name"/>
        </li>
        <li class="si-item">
          <s:input class="form-input size-input-sign-up" type="text" path="description" placeholder="description" tabindex="2" value="${productDto.description}"/>
          <s:errors path="description"/>
        </li>
        <li class="si-item">
          <s:input class="form-input size-input-sign-up" type="text" path="protein" placeholder="protein" tabindex="3" value="${productDto.protein}"/>
          <s:errors path="protein"/>
        </li>
        <li class="si-item">
          <s:input class="form-input size-input-sign-up" type="text" path="carbohydrate" placeholder="carbohydrate" tabindex="4" value="${productDto.carbohydrate}"/>
          <s:errors path="carbohydrate"/>
        </li>
        <li class="si-item">
          <s:input class="form-input size-input-sign-up" type="text" path="fat" placeholder="fat" tabindex="5" value="${productDto.fat}"/>
          <s:errors path="fat"/>
        </li>
        <li class="si-item">
          <s:input class="form-input size-input-sign-up" type="text" path="vitamin" placeholder="vitamin" tabindex="6" value="${productDto.vitamin}"/>
          <s:errors path="vitamin"/>
        </li>
        <s:hidden path="productId" value="${productDto.productId}"/>
        <li class="si-item">
          <button class="button-custom" type="submit">Update</button>
        </li>
      </ul>
    </s:form>
  </section>
